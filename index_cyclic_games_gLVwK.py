...
pairwise_interactions = generalized_rps(pairwise_interactions, 6, 2, even_groups_for_rps,seed_groups=12,seed_sparcity=12, sparcity=0.2, seed_interactions=12, interaction_std=0.1, off_target_interactions=False)
