import numpy as np
import pandas as pd
from parameters import generate_growth_rates, generate_interactions, generate_starting_abundances, adjust_selfinteractions, generate_abundance_call, add_sparcity
...
higher-order interactions. Calls appropriate functions for generating interaction values, starting
abundances and for generating trajectories. To modify simulations, modify input values for functions.
...
pairwise_interactions = generate_interactions(n, 1, seed_interactions=12,mean=0, std=0.00004)
...
tertiary_interactions = generate_interactions(n, 2,seed_interactions=12, mean=-0.000004,std= 0.1)
